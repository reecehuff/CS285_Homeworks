...
class MLPPolicyPG(MLPPolicy):
    ...
    def update(self, observations, actions, advantages, q_values=None):
        ...
        # pred_actions2 = self.forward(observations)
        # print(pred_actions)
        # print(pred_actions2)
        # print(pred_actions == pred_actions2)
        loss = -1 * torch.sum( advantages * pred_actions.log_prob(actions) )
        loss.backward()
        self.optimizer.step()
        ...
        if self.nn_baseline:
            ...
            bl_loss = self.baseline_loss(self.baseline(observations).squeeze(), q_values)
            bl_loss.backward()
