...
class PGAgent(BaseAgent):
    ...
    def _discounted_return(self, rewards):
        ...
        """
        discount_r = np.array([ (self.gamma**i)*rewards[i] for i in range(len(rewards)) ])
        total_r    = np.sum(discount_r)
        list_of_discounted_returns = [total_r] * len(rewards)
    ...
    def _discounted_cumsum(self, rewards):
        ...
        for i in range(T):
            list_of_discounted_cumsums.append( np.sum(rewards[i:] * gammas[:T-i]) )
